...
/**
 * @brief Obtener la despricpcion del juego
 * game_get_description(Game* game) devuelve la descripcion del juego (game)
 * @param game puntero al juego del que deseamos conocer la descripcion
 * @return descripcion del juego, NULL en caso de error.
 *
 */
