...
/**
 * @brief Sets a desciption for an space
 *
 * space_set_description(space* space, char* name) set a given space_get_description
 ...
 * @return id of the west link
 */
Id space_get_west(Space* space);

/**
 * @brief Sets an space to a space
 *
