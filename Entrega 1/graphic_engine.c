 ...
 * @brief Motor grafico
 *
 * Esta estructura define un motor grafico
 */
struct _Graphic_engine{
  Area *map, *descript, *banner, *help, *feedback;   /*!< Mapa, Descripcion, Banner, Ayuda, Retroalimentacion */
};
...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game){
  ...
  sprintf(str, "     next or n, back or b, pick or p, drop or d, exit or e");
  screen_area_puts(ge->help, str);
