...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game){
  ...
  if ((id_act = game_get_player_location(game)) != NO_ID){
    ...
    if (id_back != NO_ID) {
      if (space_get_illuminated(game_get_space(game, id_back)))
    ...
    if (id_act != NO_ID) {
      sprintf(str, "  +-----------+");
      screen_area_puts(ge->map, str);
      if (space_get_illuminated(space_act))
    ...
    if (id_next != NO_ID) {
      ...
      sprintf(str, "  +-----------+");
      screen_area_puts(ge->map, str);
      if (space_get_illuminated(game_get_space(game, id_next)))
  ...
  sprintf(str, "     next or n, back or b, turnon or t+, turnoff or t-, look or l, exit or e");
  screen_area_puts(ge->help, str);
