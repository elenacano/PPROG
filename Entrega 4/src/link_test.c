...
void test1_link_set_status() {
    Link *l;
    l = link_create(5);
    PRINT_TEST_RESULT(link_set_status(l, OPENED) == OK);
}

void test2_link_set_status() {
    Link *l =NULL;
    PRINT_TEST_RESULT(link_set_status(l, OPENED) == ERROR);
}
void test1_link_get_status() {
    Link *l;
    l = link_create(5);
    link_set_status(l, OPENED);
    PRINT_TEST_RESULT(link_get_status(l) == OPENED);
}
