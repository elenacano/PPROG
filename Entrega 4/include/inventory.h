...
/**
 * @brief Gets maximun number of objects of an inventory
 *
 * inventory_get_maxobjects(Inventory* inventory) get the max number of a inventory
 * @param inventory pointer to the inventory from which you want to obtain the info
 * @return integer of the max objects of the inventory, -1 otherwise.
 */
