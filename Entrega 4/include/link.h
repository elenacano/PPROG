 ...
 *
 * link_get_space(Link* link) gets the id of the space connected with the space
 * that has id (id).
 * @param link pointer to the link that we want get the space.
 * @param id identifier of the space connected to the space we want.
 * @return id of the space connected with the space id, NO_ID otherwise.
 */
Id link_get_space(Link* link, Id id);
