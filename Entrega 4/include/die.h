 ...
 * @brief Creates a die
 *
 * die_create(Id id, int min, int max) sets a die
 * @param id, identifier of the die
 * min, minimun value of the die
 * max, maximun value of the die
 * @return pointer to the die that has been created if the proccess is completed succesfully, NULL if error
 */
...
/**
 * @brief Sets the default value for the die
 *
 * die_set_value(Die* die, int value) sets the defautl value for the die
 ...
 * @param die, pointer to the die
 * @return integer of the value or -1 otherwise
 */
